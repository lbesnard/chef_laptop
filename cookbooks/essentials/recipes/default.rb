...
multimedia    = %w{audacity cmus mp3blaster vlc vlc-data vlc-nox vlc-plugin-notify clementine darktable handbrake skype imagemagick youtube-dl easytag puddletag cantata gmpc lmms}
